# [Awesome Python](https://github.com/vinta/awesome-python) [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
...
* [Ajenti](https://github.com/ajenti/ajenti) - The admin panel your servers deserve. ![GitHub stars](https://img.shields.io/github/stars/ajenti/ajenti.svg?style=social)
* [django-suit](http://djangosuit.com/) - Alternative Django Admin-Interface (free only for Non-commercial use).
* [django-xadmin](https://github.com/sshwsfc/xadmin) - Drop-in replacement of Django admin comes with lots of goodies.![GitHub stars](https://img.shields.io/github/stars/sshwsfc/xadmin.svg?style=social)
* [flask-admin](https://github.com/flask-admin/flask-admin) - Simple and extensible administrative interface framework for Flask.![GitHub stars](https://img.shields.io/github/stars/flask-admin/flask-admin.svg?style=social)
* [flower](https://github.com/mher/flower) - Real-time monitor and web admin for Celery.![GitHub stars](https://img.shields.io/github/stars/mher/flower.svg?style=social)
* [Grappelli](http://grappelliproject.com) - A jazzy skin for the Django Admin-Interface.
* [Wooey](https://github.com/wooey/wooey) - A Django app which creates automatic web UIs for Python scripts. ![GitHub stars](https://img.shields.io/github/stars/wooey/wooey.svg?style=social)
...
*数据可视化的库. 更多: [awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization).*
...
*神经网络和深度学习的框架. 更多: [awesome-deep-learning](https://github.com/ChristosChristofidis/awesome-deep-learning).*
...
* [nude.py](https://github.com/hhatto/nude.py) - 裸露侦测
...
* [Bottle](http://bottlepy.org/docs/dev/index.html) - A fast, simple and lightweight WSGI micro web-framework. ![GitHub stars](https://img.shields.io/github/stars/bottlepy/bottle.svg?style=social)
* [CherryPy](http://cherrypy.org/) - A minimalist Python web framework, HTTP/1.1-compliant and WSGI thread-pooled. ![GitHub stars](https://img.shields.io/github/stars/cherrypy/cherrypy.svg?style=social)
* [Django](https://www.djangoproject.com/) - The most popular web framework in Python. ![GitHub stars](https://img.shields.io/github/stars/django/django.svg?style=social)
    * [awesome-django](https://github.com/rosarior/awesome-django)
* [Flask](http://flask.pocoo.org/) - A microframework for Python. ![GitHub stars](https://img.shields.io/github/stars/pallets/flask.svg?style=social)
    * [awesome-flask](https://github.com/humiaozuzu/awesome-flask)
* [Pyramid](https://pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework. ![GitHub stars](https://img.shields.io/github/stars/django/django.svg?style=social)
    * [awesome-pyramid](https://github.com/uralbash/awesome-pyramid)
* [Sanic](https://github.com/channelcat/sanic) - Web server that's written to go fast. ![GitHub stars](https://img.shields.io/github/stars/channelcat/sanic.svg?style=social)
* [Tornado](http://www.tornadoweb.org/en/latest/) - A Web framework and asynchronous networking library. ![GitHub stars](https://img.shields.io/github/stars/tornadoweb/tornado.svg?style=social)
* [TurboGears](http://www.turbogears.org/) - A microframework that can scale up to a full stack solution. ![GitHub stars](https://img.shields.io/github/stars/TurboGears/tg2.svg?style=social)
* [Web2py](http://www.web2py.com/) - Full-stack enterprise framework for secure database-driven web-based applications. ![GitHub stars](https://img.shields.io/github/stars/web2py/web2py.svg?style=social)
