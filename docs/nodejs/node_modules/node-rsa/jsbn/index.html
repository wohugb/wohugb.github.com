...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://wohugb.github.io/nodejs/node_modules/node-rsa/jsbn/">
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="https://github.com/wohugb/wohugb.github.com/edit/master/source/nodejs/node_modules/node-rsa/jsbn.md" title="编辑此页" class="md-content__button md-icon">
...
<span class="normal"><a href="#__codelineno-0-4">4</a></span></pre></div></td><td class="code"><div><pre><span></span><code><a id="__codelineno-0-1" name="__codelineno-0-1"></a>  <span class="nv">x</span> <span class="o">=</span> new BigInteger<span class="o">(</span><span class="s2">&quot;abcd1234&quot;</span>, <span class="m">16</span><span class="o">)</span><span class="p">;</span>
<a id="__codelineno-0-2" name="__codelineno-0-2"></a>  <span class="nv">y</span> <span class="o">=</span> new BigInteger<span class="o">(</span><span class="s2">&quot;beef&quot;</span>, <span class="m">16</span><span class="o">)</span><span class="p">;</span>
<a id="__codelineno-0-3" name="__codelineno-0-3"></a>  <span class="nv">z</span> <span class="o">=</span> x.mod<span class="o">(</span>y<span class="o">)</span><span class="p">;</span>
<a id="__codelineno-0-4" name="__codelineno-0-4"></a>  alert<span class="o">(</span>z.toString<span class="o">(</span><span class="m">16</span><span class="o">))</span><span class="p">;</span>
...
<span class="normal"><a href="#__codelineno-1-6">6</a></span></pre></div></td><td class="code"><div><pre><span></span><code><a id="__codelineno-1-1" name="__codelineno-1-1"></a>$ openssl genrsa -out key.pem
<a id="__codelineno-1-2" name="__codelineno-1-2"></a>Generating RSA private key, <span class="m">512</span> bit long modulus
<a id="__codelineno-1-3" name="__codelineno-1-3"></a>..++++++++++++
<a id="__codelineno-1-4" name="__codelineno-1-4"></a>..............++++++++++++
<a id="__codelineno-1-5" name="__codelineno-1-5"></a>e is <span class="m">65537</span> <span class="o">(</span>0x10001<span class="o">)</span>
...
<span class="normal"><a href="#__codelineno-2-3">3</a></span></pre></div></td><td class="code"><div><pre><span></span><code><a id="__codelineno-2-1" name="__codelineno-2-1"></a>$ openssl rsa -in key.pem -noout -modulus
<a id="__codelineno-2-2" name="__codelineno-2-2"></a><span class="nv">Modulus</span><span class="o">=</span>DA3BB4C40E3C7E76F7DBDD8BF3DF0714CA39D3A0F7F9D7C2E4FEDF8C7B28C2875F7EB98950B22AE82D539C1ABC1AB550BA0B2D52E3EF7BDFB78A5E817D74BBDB
...
<span class="normal"><a href="#__codelineno-3-5">5</a></span></pre></div></td><td class="code"><div><pre><span></span><code><a id="__codelineno-3-1" name="__codelineno-3-1"></a>$ openssl base64 -d <span class="p">|</span> openssl rsautl -inkey key.pem -decrypt
<a id="__codelineno-3-2" name="__codelineno-3-2"></a>1JW24UMKntVhmmDilAYC1AjLxgiWHBzTzZsCVAejLjVri92abLHkSyLisVyAdYVr
<a id="__codelineno-3-3" name="__codelineno-3-3"></a>fiS7FchtI9vupe9JF/m3Kg<span class="o">==</span>
<a id="__codelineno-3-4" name="__codelineno-3-4"></a>Hit ctrl-D or whatever your OS uses <span class="k">for</span> end-of-file. Your original plaintext should appear:
<a id="__codelineno-3-5" name="__codelineno-3-5"></a>testing$
</code></pre></div></td></tr></table></div>
</li>
</ol>
...
<p>Tom Wu 上次修改时间：9月15日星期二23:30:00 PST 2009</p>
    ...
    <nav class="md-footer__inner md-grid" aria-label="页脚" >
        ...
        <a href="../../gm/" class="md-footer__link md-footer__link--prev" aria-label="上一页: 概述" rel="prev">
        ...
        <a href="../readme/" class="md-footer__link md-footer__link--next" aria-label="下一页: Node-RSA" rel="next">
          <div class="md-footer__title">
            <div class="md-ellipsis">
              <span class="md-footer__direction">
                下一页
