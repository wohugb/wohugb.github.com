...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.3.0, mkdocs-material-8.2.7">
        ...
        <title>JavaScript中的RSA和ECC - 大鼻子</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#javascriptrsaecc" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#_2" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="源代码">
...
<div class="highlight"><pre><span></span><code>  <span class="nv">x</span> <span class="o">=</span> new BigInteger<span class="o">(</span><span class="s2">&quot;abcd1234&quot;</span>, <span class="m">16</span><span class="o">)</span><span class="p">;</span>
...
<li>
<p>生成一个新的公钥/私钥对:</p>
<div class="highlight"><pre><span></span><code>$ openssl genrsa -out key.pem
...
<li>
<p>从您的密钥中提取模数:</p>
<div class="highlight"><pre><span></span><code>$ openssl rsa -in key.pem -noout -modulus
...
<div class="highlight"><pre><span></span><code>$ openssl base64 -d <span class="p">|</span> openssl rsautl -inkey key.pem -decrypt
...
<p>Tom Wu 上次修改时间：9月15日星期二23:30:00 PST 2009</p>
    ...
    <nav class="md-footer__inner md-grid" aria-label="Footer">
        ...
        <a href="../../gm/" class="md-footer__link md-footer__link--prev" aria-label="Previous: 概述" rel="prev">
        ...
        <a href="../readme/" class="md-footer__link md-footer__link--next" aria-label="Next: Node-RSA" rel="next">
          <div class="md-footer__title">
            <div class="md-ellipsis">
              <span class="md-footer__direction">
                Next
