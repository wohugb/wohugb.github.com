...
<h3 id="_1">浏览器</h3>
<p>??? info "<code>create(text, [options])</code>"</p>
<pre><code>Creates QR Code symbol and returns a qrcode object.
...
<p>??? info "<code>toCanvas(canvasElement, text, [options], [cb(error)])</code>"</p>
<p>??? info "<code>toCanvas(text, [options], [cb(error, canvas)])</code>"</p>
<pre><code>Draws qr code symbol to canvas.
...
<p>??? info "<code>toDataURL(text, [options], [cb(error, url)])</code>"</p>
<p>??? info "<code>toDataURL(canvasElement, text, [options], [cb(error, url)])</code>"
    Returns a Data URI containing a representation of the QR Code image.
    If provided, <code>canvasElement</code> will be used as canvas to generate the data URI.</p>
<pre><code>`canvasElement`
...
<p>??? info "<code>toString(text, [options], [cb(error, string)])</code>"</p>
<pre><code>Returns a string representation of the QR Code.
...
<h3 id="_2">服务器</h3>
<p>??? info "<code>create(text, [options])</code>"</p>
<pre><code>See [create](#createtext-options).
</code></pre>
<p>??? info "<code>toCanvas(canvas, text, [options], [cb(error)])</code>"</p>
<pre><code>Draws qr code symbol to [node canvas](https://github.com/Automattic/node-canvas).
...
<p>??? info "<code>toDataURL(text, [options], [cb(error, url)])</code>"</p>
<pre><code>Returns a Data URI containing a representation of the QR Code image.
...
<p>??? info "<code>toFile(path, text, [options], [cb(error)])</code>"</p>
<pre><code>Saves QR Code to image file.
...
<p>??? info "<code>toFileStream(stream, text, [options])</code>"
    Writes QR Code image to stream. Only works with <code>png</code> format for now.</p>
<pre><code>`stream`
...
<footer class="md-footer">
    ...
    <nav class="md-footer__inner md-grid" aria-label="Footer">
        ...
        <a href="../../node-rsa/readme/" class="md-footer__link md-footer__link--prev" rel="prev">
