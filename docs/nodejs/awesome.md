...
- [image-type](https://github.com/sindresorhus/image-type) - 检测图像[Buffer/Uint8Array]类型. ![GitHub stars](https://img.shields.io/github/stars/sindresorhus/image-type.svg?style=social)
