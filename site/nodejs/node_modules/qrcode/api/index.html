...
<nav class="md-nav md-nav--secondary">
  ...
  <li class="md-nav__item">
    <a href="../readme/" title="node-qrcode" class="md-nav__link">
      node-qrcode
    </a>
  </li>
...
<details class="info"><summary><code>create(text, [options])</code></summary><p>Creates QR Code symbol and returns a qrcode object.</p>
<p><code>text</code></p>
...
<div class="codehilite"><pre><span></span><span class="c1">// QRCode object</span>
<span class="p">{</span>
...
<details class="info"><summary><code>toCanvas(canvasElement, text, [options], [cb(error)])</code></summary></details>
<details class="info"><summary><code>toCanvas(text, [options], [cb(error, canvas)])</code></summary><p>Draws qr code symbol to canvas.
...
<details class="info"><summary><code>toDataURL(text, [options], [cb(error, url)])</code></summary></details>
<details class="info"><summary><code>toDataURL(canvasElement, text, [options], [cb(error, url)])</code></summary><p>Returns a Data URI containing a representation of the QR Code image.
...
<p>Callback function called on finish.</p>
<p><strong><em>Example</em></strong></p>
<div class="codehilite"><pre><span></span><span class="kd">var</span> <span class="nx">opts</span> <span class="o">=</span> <span class="p">{</span>
...
<details class="info"><summary><code>toString(text, [options], [cb(error, string)])</code></summary><p>Returns a string representation of the QR Code.
...
<p>Callback function called on finish.</p>
<p><strong><em>Example</em></strong></p>
<div class="codehilite"><pre><span></span><span class="nx">QRCode</span><span class="p">.</span><span class="nx">toString</span><span class="p">(</span><span class="s1">&#39;http://www.google.com&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">string</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">if</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="k">throw</span> <span class="nx">err</span>
...
<details class="info"><summary><code>create(text, [options])</code></summary><p>See <a href="#createtext-options">create</a>.</p>
</details>
<details class="info"><summary><code>toCanvas(canvas, text, [options], [cb(error)])</code></summary><p>Draws qr code symbol to <a href="https://github.com/Automattic/node-canvas">node canvas</a>.</p>
<p><code>text</code></p>
<p>类型: <code>String|Array</code></p>
<p>Text to encode or a list of objects describing segments.</p>
<p><code>options</code></p>
...
<details class="info"><summary><code>toDataURL(text, [options], [cb(error, url)])</code></summary><p>Returns a Data URI containing a representation of the QR Code image.
...
<details class="info"><summary><code>toFile(path, text, [options], [cb(error)])</code></summary><p>Saves QR Code to image file.
...
<p>结束回调函数.</p>
<p><strong><em>Example</em></strong></p>
<div class="codehilite"><pre><span></span><span class="nx">QRCode</span><span class="p">.</span><span class="nx">toFile</span><span class="p">(</span><span class="s1">&#39;path/to/filename.png&#39;</span><span class="p">,</span> <span class="s1">&#39;Some text&#39;</span><span class="p">,</span> <span class="p">{</span>
...
<details class="info"><summary><code>toFileStream(stream, text, [options])</code></summary><p>Writes QR Code image to stream. Only works with <code>png</code> format for now.</p>
...
<details class="info"><summary>QR Code 选项</summary><p><code>version</code></p>
<p>类型: <code>Number</code></p>
...
<details class="info"><summary>渲染器选项</summary><p><code>margin</code></p>
<p>类型: <code>Number</code></p>
<p>默认:  <code>4</code></p>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../../node-rsa/readme/" title="Node-RSA" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../readme/" title="node-qrcode" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  前进
